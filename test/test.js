describe('NFTMarket', function () {
  it('Should interact with the token contract', async function () {
    ...
    await market
      .connect(userAddress)
      .createMarketSale(nftContractAddress, 1, { value: deposit });
    await market
      .connect(userAddress2)
      .createMarketSale(nftContractAddress, 2, { value: deposit });
    await market
      .connect(userAddress2)
      .createMarketSale(nftContractAddress, 3, { value: deposit });
